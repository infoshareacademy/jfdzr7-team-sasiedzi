  ...
  return (
    <form>
      ...
      <div>
        ...
        <input type="text" id="houseNumber" value={newUser.houseNumber} name="houseNumber" onChange={onChange}></input>
      </div>

      <div>
        <label htmlFor="phoneNumber">Phone number: </label>
        <input type="text" id="phoneNumber" value={newUser.phoneNumber} name="phoneNumber" onChange={onChange}></input>
      </div>
      <div>
